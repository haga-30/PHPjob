...
<body>
    <div>
        <h2>ログイン画面</h2>
        <button style = "background-color: #ffa500"; class="btn" onclick="location.href='register.php'">新規ユーザー登録</button>
    </div>
    <form action="" method="post"><br>
        ...
        <input class="button" type="submit" value="ログイン" style = "background-color: #00ffff";>
    </form>
</body>
</html>